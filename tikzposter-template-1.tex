...
\usepackage{xcolor}
\definecolor{orange}{RGB}{255,82,0}
...
\author{Author(s)}
\institute{Institute}
\titlegraphic{\includegraphics[height=10\baselineskip]{logo}}
\makeatletter
\renewcommand\TP@maketitle{%
 ...
 \tikz[remember picture,overlay]\node[scale=0.8,anchor=east,xshift=0.56\linewidth,yshift=3.9cm,inner sep=0pt] {%
     ...
     \tikz[remember picture,overlay]\node[scale=0.6,anchor=west,xshift=0.65\linewidth,yshift=2.9cm,inner sep=0pt] {%
        \includegraphics[height=8.5\baselineskip]{JuliaSetECUColors}
        };
...
\makeatother
 ...
 %Choose Layout
\usetheme{Envelope}
\usecolorstyle[colorOne=orange,colorTwo=black,colorThree=gray]{Germany}
